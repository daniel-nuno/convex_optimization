...
if __name__ == '__main__':
    m = MultiCommodityInterdiction('https://raw.githubusercontent.com/Pyomo/PyomoGallery/master/network_interdiction/multi_commodity_flow/sample_nodes_data.csv',
                                    'https://raw.githubusercontent.com/Pyomo/PyomoGallery/master/network_interdiction/multi_commodity_flow/sample_nodes_commodity_data.csv',
                                    'https://raw.githubusercontent.com/Pyomo/PyomoGallery/master/network_interdiction/multi_commodity_flow/sample_arcs_data.csv',
                                    'https://raw.githubusercontent.com/Pyomo/PyomoGallery/master/network_interdiction/multi_commodity_flow/sample_arcs_commodity_data.csv')
    m.solve()
    m.printSolution()
    m.attacks = 1
    m.solve()
