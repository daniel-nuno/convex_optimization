...
if __name__ == '__main__':
    m = SPInterdiction('https://raw.githubusercontent.com/Pyomo/PyomoGallery/master/network_interdiction/shortest_path/sample_nodes_data.csv',
                        'https://raw.githubusercontent.com/Pyomo/PyomoGallery/master/network_interdiction/shortest_path/sample_arcs_data.csv')
    m.solve()
    m.printSolution()
    m.attacks = 1
    m.solve()
